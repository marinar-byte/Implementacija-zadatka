...
class Offer(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, default=1)  # ForeignKey to Django's built-in User model
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE)  # ForeignKey to Customer # Django's built-in User model
